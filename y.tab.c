...
{
       0,     0,     3,     8,    12,    15,    16,    22,    25,    26,
      31,    37,    43,    50,    59,    66,    67,    69,    71,    73,
      77,    81,    85,    89,    93,    94,    96,    98,   100,   102
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      14,    35,    15,    23,    32,    -1,    -1,    25,    -1,    24,
      -1,    16,    -1,    35,    17,    35,    -1,    25,    17,    25,
      -1,    25,    17,    35,    -1,    35,    17,    25,    -1,    36,
      18,    36,    -1,    -1,    37,    -1,    35,    -1,    34,    -1,
      34,    -1,    37,    20,    37,    -1
};
...
{
       0,    44,    44,    48,    52,    52,    56,    60,    60,    64,
      68,    69,    70,    71,    72,    72,    76,    76,    80,    80,
      81,    82,    83,    84,    84,    88,    88,    88,    92,    92
};
#endif
...
{
  "$end", "error", "$undefined", "T_PROGRAM", "T_PONTEVIRG", "T_VAR",
  "T_TIPO", "T_VIRG", "T_PONTO", "T_DOISPONTO", "T_BEGIN", "T_IF",
  "T_THEN", "T_ELSE", "T_ABRE_P", "T_FECHA_P", "T_BOOL", "T_O_LOGICO",
  "T_COMP", "T_ATRIB", "T_OPERACAO", "T_END", "T_WHILE", "T_DO", "T_NUM",
  "T_IDENTIF", "$accept", "program", "code", "vars", "var_declaration",
  "multi", "commands", "command", "value", "p", "r", "math", 0
};
#endif
...
{
       0,     0,     0,     0,     1,     5,     0,     2,     0,     0,
       4,    15,     0,     8,     0,     0,     0,     0,     3,     0,
       0,    24,    24,    24,     0,     7,     0,    18,    17,    16,
      27,    26,     0,    25,    26,    27,    26,     0,     9,     6,
      24,     0,    24,    24,     0,     0,    15,    15,    16,    21,
       0,    16,    19,    23,    16,    28,    29,     0,    10,    11,
      12,    14,     0,    13
};
...
{
      31,    34,    46,    35,    27,    37,    14,    41,    47,    42,
      28,    54,    28,    29,     3,   -20,   -22,    15,   -28,    49,
      16,    52,    43,    60,    55,    53,   -20,   -22,    40,    40,
...
{
      21,    22,     4,    23,    16,    23,    11,    15,     4,    17,
      24,    25,    24,    25,    25,     4,     4,    22,    20,    40,
